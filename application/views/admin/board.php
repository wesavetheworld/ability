...
<div class="navbar">
    <div class="navbar-inner">
        ...
        <a class="brand" href="<?php echo site_url('admin')?>"><span class="first">Antfoot</span> <span class="second">管理后台</span></a>
    </div>
</div>
...
<div class="sidebar-nav">
    ...
    <ul id="dashboard-menu" class="nav nav-list collapse in">
        <li><a href="<?php echo site_url('admin'); ?>">后台首页</a></li>
        <li ><a href="javascript:;" class="j_ajax_method" alt-href="<?php echo site_url('admin/users'); ?>">用户管理</a></li>
